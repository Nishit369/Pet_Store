...
const updateScrollButtons = () => {
  ...
  return <section className="py-16 px-4 lg:px-0">
    <div className="container mx-auto text-center mb-10 relative">
      <h2 className="text-3xl font-bold mb-4">Explore Latest Products</h2>
      <p className="text-lg text-gray-600 mb-8">Discover latest and wide range of products for your loved ones</p>
